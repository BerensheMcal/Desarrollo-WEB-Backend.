...
const admin_productos_controller_1 = require("./admin-productos.controller");
...
exports.ProductosModule = ProductosModule = __decorate([
    (0, common_1.Module)({
        imports: [typeorm_1.TypeOrmModule.forFeature([producto_entity_1.Producto, imagen_producto_entity_1.ImagenProducto])],
        controllers: [productos_controller_1.ProductosController, admin_productos_controller_1.AdminProductosController],
