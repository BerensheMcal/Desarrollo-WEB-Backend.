...
const admin_categorias_controller_1 = require("./admin-categorias.controller");
const categoria_entity_1 = require("../../database/entities/categoria.entity");
...
exports.CategoriasModule = CategoriasModule = __decorate([
    (0, common_1.Module)({
        ...
        controllers: [categorias_controller_1.CategoriasController, admin_categorias_controller_1.AdminCategoriasController],
